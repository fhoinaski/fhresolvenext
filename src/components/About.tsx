...
const About: React.FC = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="py-16 sm:py-20 bg-[var(--color-light)] relative"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="flex items-start gap-4 mb-8 p-4 bg-white rounded-lg shadow-sm"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              {infoItems.map((item, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  className="p-4 rounded-lg bg-white shadow-sm border border-[var(--color-neutral)]/10"
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-[var(--color-text)]/80">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          >
            <div className="relative">
              <div className="aspect-video sm:aspect-square rounded-lg overflow-hidden shadow-lg border border-[var(--color-neutral)]/10">
