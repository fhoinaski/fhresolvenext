...
const Hero: React.FC = () => {
  ...
  const contentOpacity = useTransform(scrollYProgress, [0, 0.5], [1, prefersReducedMotion ? 1 : 0.3]);
  const contentScale = useTransform(scrollYProgress, [0, 0.5], [1, prefersReducedMotion ? 1 : 0.95]);
  ...
  useEffect(() => {
    ...
    // Animação de parallax aprimorada
    gsap.to('.hero-bg', {
      y: '40%',
      ease: 'none',
      scrollTrigger: {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ref={contentRef} 
        className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20"
        style={{ 
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.div 
              ...
              className="mb-6 inline-flex items-center px-4 py-2 rounded-full 
            ...
            >
              ...
              <span className="block text-3xl sm:text-4xl lg:text-5xl xl:text-6xl mt-2 text-white/90">
                para sua Casa
              </span>
            </motion.h1>
            ...
            {/* Subtitle */}
            <motion.p 
              className="text-lg sm:text-xl lg:text-2xl leading-relaxed text-white/80 mb-8 max-w-2xl mx-auto lg:mx-0"
              variants={slideUpVariants}
              initial="hidden"
              animate="visible"
      ...
      >
        ...
        >
          <span className="text-white/70 text-sm mb-3 group-hover:text-white/90 transition-colors">
            Saiba Mais
          </span>
          <motion.div 
